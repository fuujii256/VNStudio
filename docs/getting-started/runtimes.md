...
| ランタイム | 状態 | 利用者が用意するもの |
|---|---|---|
| PSP | 利用できます | なし (エミュレータ PPSSPP も自動でダウンロードします) |
| X68000 | 利用できます | RetroArch と PX68k コア、X68000 の IPL/CG ROM、Human68k の起動 HDF |
| MSX (V9990) | 利用できます | openMSX、MSX turboR (Panasonic FS-A1GT) のシステム ROM |
| XZ80 | 準備中 | — |
